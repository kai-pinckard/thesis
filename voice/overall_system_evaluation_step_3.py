...
model = RobertaForSequenceClassification.from_pretrained(
    './step_3_casual_sentence_classifier_model', # use my stored model
...
# Load the dataset
with open("../classifier/semeval2010task8/semeval_test_set_step_3V4.json", "r") as f:
...
print(sentences[0])
test_labels = [ item["is_active"] for item in test_data]
print(test_labels[0])
...
with open("step_3_results", "w") as f:
