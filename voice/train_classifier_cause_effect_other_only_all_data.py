...
val_sentences =[ item["sent"].lower() for item in val_data]
...
train_labels = [ item["relation_type"] for item in train_data]
train_labels[0]

val_labels = [ item["relation_type"] for item in val_data]
val_labels[0]
...
sentences = [ item["sent"].lower() for item in test_data]
...
output_dir = './bert_base_uncased_4epochs_32batch_semeval_train_chinese_9600/'
